...
const CourseCatalog = () => {
    ...
    useEffect(() => {
        fetch('http://https://mindova-learning-application.onrender.com/api/courses')
            .then(res => res.json())
    ...
    const enroll = async (courseId) => {
        ...
        try {
            const res = await fetch(`http://https://mindova-learning-application.onrender.com/api/courses/${courseId}/enroll`, {
                method: 'POST',
                headers: { 
